...
// yeah I know KC is keycode and md is my initials, just trying to make it more readable...
#define MD_LOWER LT(_LOWER, KC_BSPC)
#define MD_RAISE LT(_RAISE, KC_ENT)
#define MD_DIRESC LT(_ADJUST, KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LALT,MD_LOWER, KC_BSPC,    KC_SPC, MD_RAISE, KC_RALT
                                      //`--------------------------'  `--------------------------'
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       KC_DLR,KC_COLON, KC_LABK, KC_RABK, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   KC_AT, KC_PIPE,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      KC_TILD,KC_COLON, _______, _______, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CIRC, KC_BSLS,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
